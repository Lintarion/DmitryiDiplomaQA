...
Ожидаемый результат:
*  Появляется всплывающее окно "Операция одобрена Банком"
*  В БД в credit_request_entity появиляется запись со статусом APPROVED
...
5. Невалидный номер дебетовой карты
...
6. Невалидный номер кредитной карты
* Ввод номера 1111 1111 1111 1111 в поле Номер карты 
* Остальные поля заполнить корректными значениями
* Клик по кнопке *Продолжить*
...
7. Неполный ввод номера в поле Номер карты для покупки по дебетовой карте
...
8. Неполный ввод номера в поле Номер карты для покупки по кредитной карте
* Ввести номер 1111 1111 1111 111 в поле Номер карты
* Остальные поля заполнить корректными значениями
*  Клик по кнопке *Продолжить*
...
24. Покупка по кредитной карте при пустом поле Месяц
...
25. Покупка по дебетовой карте при пустом поле Год
...
26. Покупка по кредитной карте при пустом поле Месяц
...
27. Покупка по дебетовой карте при пустом поле Владелец
...
28. Покупка по кредитной карте при пустом поле Владелец
...
29. Покупка по дебетовой карте при пустом поле CVC
...
30. Покупка по кредитной карте при пустом поле CVC
...
31. Покупка по дебетовой карте при вводе 0 поле CVC 
...
32. Покупка по кредитной карте при вводе 0 поле CVC 
...
36. Покупка по кредитной карте с вводом 0 в поле Год
* Ввод номера 00 в поле Год
* Остальные поля заполнить корректными значениями
